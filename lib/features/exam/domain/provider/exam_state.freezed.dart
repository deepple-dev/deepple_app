...
mixin _$ExamState {
 ...
 QuestionData get questionList; SoulmateData get soulmateList; int get currentSubjectIndex; PersonalityType get personalityType; bool get isDone; bool get hasResultData; bool get hasSoulmate; bool get isLoaded; int get currentPage; Map<int, int> get currentAnswerMap; QuestionListErrorType? get error;
...
@useResult
$Res call({
 QuestionData questionList, SoulmateData soulmateList, int currentSubjectIndex, PersonalityType personalityType, bool isDone, bool hasResultData, bool hasSoulmate, bool isLoaded, int currentPage, Map<int, int> currentAnswerMap, QuestionListErrorType? error
});
...
/// Create a copy of ExamState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? questionList = null,Object? soulmateList = null,Object? currentSubjectIndex = null,Object? personalityType = null,Object? isDone = null,Object? hasResultData = null,Object? hasSoulmate = null,Object? isLoaded = null,Object? currentPage = null,Object? currentAnswerMap = null,Object? error = freezed,}) {
...
as int,personalityType: null == personalityType ? _self.personalityType : personalityType // ignore: cast_nullable_to_non_nullable
as PersonalityType,isDone: null == isDone ? _self.isDone : isDone // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( QuestionData questionList,  SoulmateData soulmateList,  int currentSubjectIndex,  PersonalityType personalityType,  bool isDone,  bool hasResultData,  bool hasSoulmate,  bool isLoaded,  int currentPage,  Map<int, int> currentAnswerMap,  QuestionListErrorType? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExamState() when $default != null:
return $default(_that.questionList,_that.soulmateList,_that.currentSubjectIndex,_that.personalityType,_that.isDone,_that.hasResultData,_that.hasSoulmate,_that.isLoaded,_that.currentPage,_that.currentAnswerMap,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( QuestionData questionList,  SoulmateData soulmateList,  int currentSubjectIndex,  PersonalityType personalityType,  bool isDone,  bool hasResultData,  bool hasSoulmate,  bool isLoaded,  int currentPage,  Map<int, int> currentAnswerMap,  QuestionListErrorType? error)  $default,) {final _that = this;
switch (_that) {
case _ExamState():
return $default(_that.questionList,_that.soulmateList,_that.currentSubjectIndex,_that.personalityType,_that.isDone,_that.hasResultData,_that.hasSoulmate,_that.isLoaded,_that.currentPage,_that.currentAnswerMap,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( QuestionData questionList,  SoulmateData soulmateList,  int currentSubjectIndex,  PersonalityType personalityType,  bool isDone,  bool hasResultData,  bool hasSoulmate,  bool isLoaded,  int currentPage,  Map<int, int> currentAnswerMap,  QuestionListErrorType? error)?  $default,) {final _that = this;
switch (_that) {
case _ExamState() when $default != null:
return $default(_that.questionList,_that.soulmateList,_that.currentSubjectIndex,_that.personalityType,_that.isDone,_that.hasResultData,_that.hasSoulmate,_that.isLoaded,_that.currentPage,_that.currentAnswerMap,_that.error);case _:
  return null;
...
class _ExamState extends ExamState {
  const _ExamState({required this.questionList, required this.soulmateList, required this.currentSubjectIndex, required this.personalityType, required this.isDone, required this.hasResultData, required this.hasSoulmate, this.isLoaded = false, this.currentPage = 0, final  Map<int, int> currentAnswerMap = const {}, this.error}): _currentAnswerMap = currentAnswerMap,super._();
...
@override
int get hashCode => Object.hash(runtimeType,questionList,soulmateList,currentSubjectIndex,personalityType,isDone,hasResultData,hasSoulmate,isLoaded,currentPage,const DeepCollectionEquality().hash(_currentAnswerMap),error);
...
/// Create a copy of ExamState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? questionList = null,Object? soulmateList = null,Object? currentSubjectIndex = null,Object? personalityType = null,Object? isDone = null,Object? hasResultData = null,Object? hasSoulmate = null,Object? isLoaded = null,Object? currentPage = null,Object? currentAnswerMap = null,Object? error = freezed,}) {
