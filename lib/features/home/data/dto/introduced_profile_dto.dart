...
abstract class IntroducedProfileDto with _$IntroducedProfileDto {
  const factory IntroducedProfileDto({
    ...
    @HiveField(5) String? likeLevel,
    @HiveField(6) required bool isIntroduced,
    @HiveField(7) required int age,
    @HiveField(8) required String nickname,
    @HiveField(9) required String city,
    @HiveField(10) required String district,
