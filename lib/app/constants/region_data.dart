...
final addressData = AddressData(
  cities: [
    ...
    CityAddressItem(label: '세종특별자치시', value: 'SEJONG'),
    CityAddressItem(
      label: '강원도',
      value: 'GANGWON',
      districts: [
    ...
    CityAddressItem(
      ...
      districts: [
        ...
        DistrictAddressItem(label: '산청군', value: 'SANCHANG_GUN'),
    ...
    CityAddressItem(
      ...
      districts: [
        ...
        DistrictAddressItem(label: '군위군', value: 'GUNWI_GUN'),
        ...
        DistrictAddressItem(label: '울릉군', value: 'ULLUNG_GUN'),
        ...
        DistrictAddressItem(label: '포항시', value: 'POHANG_SI'),
      ],
    ),
    CityAddressItem(
      label: '전라남도',
      ...
      districts: [
        ...
        DistrictAddressItem(label: '해남군', value: 'HAENAM_GUN'),
        DistrictAddressItem(label: '화순군', value: 'HWASUN_GUN'),
      ],
    ),
    CityAddressItem(
      label: '전라북도',
      ...
      districts: [
        ...
        DistrictAddressItem(label: '임실군', value: 'IMSIL_GUN'),
        DistrictAddressItem(label: '장수군', value: 'JANGSU_GUN'),
        DistrictAddressItem(label: '전주시', value: 'JEONJU_SI'),
        DistrictAddressItem(label: '진안군', value: 'JINAN_GUN'),
    ...
    CityAddressItem(
      ...
      districts: [
        DistrictAddressItem(label: '계룡시', value: 'GYERYONG_SI'),
        DistrictAddressItem(label: '공주시', value: 'GONGJU_SI'),
        DistrictAddressItem(label: '금산군', value: 'GEUMSAN_GUN'),
        DistrictAddressItem(label: '논산시', value: 'NONSAN_SI'),
        DistrictAddressItem(label: '당진시', value: 'DANGJIN_SI'),
        DistrictAddressItem(label: '보령시', value: 'BORYEONG_SI'),
        DistrictAddressItem(label: '부여군', value: 'BUYEO_GUN'),
        DistrictAddressItem(label: '서산시', value: 'SEOSAN_SI'),
        DistrictAddressItem(label: '서천군', value: 'SECHEON_GUN'),
    ...
    CityAddressItem(
      ...
      districts: [
        ...
        DistrictAddressItem(label: '충주시', value: 'CHUNGJU_SI'),
      ],
    ),
    CityAddressItem(
      label: '제주',
